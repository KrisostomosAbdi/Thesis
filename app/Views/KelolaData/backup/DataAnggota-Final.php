                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($a->no_telepon != '0') : ?>
                                                            <a href="https://api.whatsapp.com/send?phone=<?= $a->no_telepon; ?>"><i class="bi bi-whatsapp"></i></a>
                                                        <?php else : ?>
                                                            <a href="#" disabled><i class="bi bi-whatsapp"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                    <!-- <td><?= $a->tanggal_masuk . " " . ($diff = date_diff(date_create($a->tanggal_masuk), date_create(date("Y-m-d")))->format('%y')); ?></td> -->
                                                    <!-- <td><?= ($diff = date_diff(date_create($a->tanggal_lahir), date_create(date("Y-m-d")))->format('%y')); ?></td> -->
                                                    <!-- <td><?= $jml_kegiatan; ?></td> -->
                                                    <!-- <td><?= $percent; ?></td> -->
                                                    <!-- <td><?php
                                                                echo $jmlMingguInactive;
                                                                d($result4);
                                                                echo $jmlMinggu;
                                                                ?></td> -->
