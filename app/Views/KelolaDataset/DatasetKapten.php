                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body table-responsive text-center">
                                <h3 class="fw-bold" style="margin-top:15px;color: #444441;">DATASET KAPTEN</h3>
                                <p style="display:inline;">
                                    last update: <?php if ($dataset != null) : ?>
                                        <?= $dataset['created_at']; ?>
                                    <?php else : ?>
                                        <?= '-'; ?>
                                    <?php endif;; ?>
                                ...
                                <form style="display: none" class="text-center" action="/KelolaDataset/uploadDataset/<?= $jenis = "kapten"; ?>" id="updateform" method="post" enctype="multipart/form-data">
                                ...
                                <div class="operatorbtn" style="margin-top:5px;margin-bottom: 10px;">
                                    ...
                                    <button type="button" class="btn btn-success"><a class="text-decoration-none" style="color: white; background-color: transparent; text-decoration: none;" download="datasetkapten.csv" href="#" onclick="return ExcellentExport.csv(this, 'tabeldata3');">Export to CSV</a></button>
                                ...
                                <table id="tabeldata3" class="table table-bordered text-center table-striped  overflow-auto">
                                    <thead>
                                        <tr>
                                            <!-- <th scope="col">#</th>
