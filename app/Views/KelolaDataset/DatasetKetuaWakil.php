                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body table-responsive text-center ">
                                <h3 class="fw-bold text-center" style="margin-top:15px;color: #444441;">DATASET KETUA-WAKIL KETUA</h3>
                                ...
                                <form style="display: none" class="text-center" action="/KelolaDataset/uploadDataset/<?= $jenis = "ketuawakil"; ?>" id="updateform" method="post" enctype="multipart/form-data">
                                ...
                                <div class="operatorbtn" style="margin-top:5px;margin-bottom: 10px;">
                                    ...
                                    <button type="button" class="btn btn-success"><a class="text-decoration-none" style="color: white; background-color: transparent; text-decoration: none;" download="datasetketuawakil.csv" href="#" onclick="return ExcellentExport.csv(this, 'tabeldata2');">Export to CSV</a></button>


                                </div>
                                <!-- <h2 class="card-title text-center">DATASET KETUA-WAKIL KETUA</h2> -->
                                <!-- Button trigger modal -->
                                ...
                                <table id="tabeldata2" class="table table-bordered text-center table-striped  overflow-auto">
                                    <thead>
                                        <tr>
                                            <!-- <th scope="col">#</th>
                                            ...
                                            <th scope="col">kandidat_ketua_wakil</th>
